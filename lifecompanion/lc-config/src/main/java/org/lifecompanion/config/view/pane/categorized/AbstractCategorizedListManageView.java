...
import org.lifecompanion.config.view.pane.tabs.useaction.part.UseActionListManageView;
import org.lifecompanion.config.view.reusable.OrderModifiableListView;
...
public abstract class AbstractCategorizedListManageView<M, V extends CategorizedElementI<T>, T extends SubCategoryI<K, V>, K extends MainCategoryI<T>>
    ...
    public void initUI() {
        ...
        this.buttonAddElementWhenEmpty = UIUtils.createTextButtonWithGraphics(this.getAddWhenEmptyButtonText(),
                LCGlyphFont.FONT_AWESOME.create(FontAwesome.Glyph.PLUS_CIRCLE).sizeFactor(2).color(LCGraphicStyle.MAIN_DARK),
