...
public class SelectionModeSuppParamView extends BaseConfigurationViewBorderPane<SelectionModeUserI> implements LCViewInitHelper {
    ...
    private KeySelectorControl keySelectorControlKeyboardNextScanKey;
    ...
    public void bind(SelectionModeUserI model) {
        ...
        this.keySelectorControlKeyboardNextScanKey.valueProperty().set(model.getSelectionModeParameter().keyboardNextScanKeyProperty().get());
    ...
    public void saveChanges() {
        ...
        model.get().getSelectionModeParameter().keyboardNextScanKeyProperty().set(keySelectorControlKeyboardNextScanKey.valueProperty().get());
    ...
    public void initUI() {
        ...
        this.keySelectorControlKeyboardNextScanKey = new KeySelectorControl(null);
        labelKeyboardNextScanKey = new Label(Translation.getText("selection.mode.scanning.manual.input.keyboard.key"));
        labelKeyboardNextScanKey.disableProperty().bind(keySelectorControlKeyboardNextScanKey.disabledProperty());
        this.keyboardControlNodes = Arrays.asList(labelKeyboardNextScanKey, keySelectorControlKeyboardNextScanKey);
    ...
    public void initBinding() {
        ...
        this.keySelectorControlKeyboardNextScanKey.disableProperty().bind(comboBoxScanningMode.valueProperty().isNotEqualTo(ScanningMode.MANUAL));
    ...
    private void updateConfigurationGridPaneForCurrentMode(SelectionModeEnum selectionModeEnum) {
        ...
        if (selectionModeEnum != null) {
            ...
            if (selectionModeEnum.useScanningProperty().get()) {
                ...
                gridPaneConfiguration.add(keySelectorControlKeyboardNextScanKey, 1, gridRowIndex);
