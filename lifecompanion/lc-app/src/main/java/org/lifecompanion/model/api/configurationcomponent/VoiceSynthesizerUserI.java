...
/**
 * Represent a component that can use the voice synthesizer, so that can set its parameters.
 * @author Mathieu THEBAUD <math.thebaud@gmail.com>
 */
public interface VoiceSynthesizerUserI {

	/**
	 * @return the parameters for voice synthesizer.
	 */
