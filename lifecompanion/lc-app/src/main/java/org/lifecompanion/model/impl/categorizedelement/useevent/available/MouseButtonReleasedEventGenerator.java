...
public class MouseButtonReleasedEventGenerator extends BaseUseEventGeneratorImpl {

    @XMLGenericProperty(MouseButton.class)
    private ObjectProperty<MouseButton> wantedButton;

    public MouseButtonReleasedEventGenerator() {
        super();
        this.parameterizableAction = true;
        this.order = 3;
        this.category = DefaultUseEventSubCategories.CLIC;
        this.wantedButton = new SimpleObjectProperty<>(MouseButton.ANY);
        this.nameID = "use.event.clic.mouse.button.released.name";
        this.staticDescriptionID = "use.event.clic.mouse.button.released.description";
        this.variableDescriptionProperty().set(this.getStaticDescription());
        this.configIconPath = "control/icon_mouse_button_released.png";
    }
    ...
    public void modeStart(final LCConfigurationI configuration) {
        SelectionModeController.INSTANCE.addMouseEventListener((mouseEvent) -> {
            ...
            if (useEventListener != null && mouseEvent.getEventType() == MouseEvent.MOUSE_RELEASED && (this.wantedButton.get().checkEvent(mouseEvent))) {
    ...
    public Element serialize(final IOContextI context) {
        ...
        XMLObjectSerializer.serializeInto(MouseButtonReleasedEventGenerator.class, this, element);
        return element;
    }
    ...
    public void deserialize(final Element node, final IOContextI context) throws LCException {
        ...
        XMLObjectSerializer.deserializeInto(MouseButtonReleasedEventGenerator.class, this, node);
    }
    //========================================================================
