...
public class OnActivationDoneEventGenerator extends BaseUseEventGeneratorImpl {

    public OnActivationDoneEventGenerator() {
        super();
        this.parameterizableAction = false;
        this.order = 0;
        this.category = DefaultUseEventSubCategories.MISCELLANEOUS;
        this.nameID = "use.event.on.activation.indication.done.name";
    ...
    public void modeStart(final LCConfigurationI configuration) {
        ...
        IndicationController.INSTANCE.getOnActivationDoneListeners().add(this.listener);
    }

    @Override
    public void modeStop(final LCConfigurationI configuration) {
        IndicationController.INSTANCE.getOnActivationDoneListeners().remove(this.listener);
        this.listener = null;
    }
}
