...
public class UpperCaseDisableEventGenerator extends BaseUseEventGeneratorImpl {

	public UpperCaseDisableEventGenerator() {
		super();
		this.parameterizableAction = false;
		this.order = 1;
		this.category = DefaultUseEventSubCategories.STATUS;
		this.nameID = "use.event.configuration.upper.case.disable.name";
		this.staticDescriptionID = "use.event.configuration.upper.case.disable.description";
		this.configIconPath = "configuration/icon_uppercase_disabled.png";
