 ...
 */
public class StopCurrentUserActionSequenceAction extends SimpleUseActionImpl<GridPartKeyComponentI> {

    public StopCurrentUserActionSequenceAction() {
        super(GridPartKeyComponentI.class);
        this.order = 0;
        this.category = DefaultUseActionSubCategories.UA_SEQUENCE_GENERAL;
        this.nameID = "stop.current.user.action.sequence.name";
        this.staticDescriptionID = "stop.current.user.action.sequence.description";
        this.configIconPath = "sequence/stop_current_sequence.png";
