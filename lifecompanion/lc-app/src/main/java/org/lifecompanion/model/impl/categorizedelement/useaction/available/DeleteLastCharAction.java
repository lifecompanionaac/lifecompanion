 ...
 */
public class DeleteLastCharAction extends SimpleUseActionImpl<UseActionTriggerComponentI> {

	public DeleteLastCharAction() {
		super(UseActionTriggerComponentI.class);
		this.category = DefaultUseActionSubCategories.DELETE_TEXT;
		this.nameID = "action.delete.last.char.name";
		this.staticDescriptionID = "action.delete.last.char.description";
		this.variableDescriptionProperty().set(this.getStaticDescription());
		this.configIconPath = "text/icon_delete_last_char.png";
