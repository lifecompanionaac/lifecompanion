...
/**
 * Configuration view for event generator
 * @author Mathieu THEBAUD <math.thebaud@gmail.com>
 * @param <T> configured event type
 */
public interface UseEventGeneratorConfigurationViewI<T extends UseEventGeneratorI> extends CategorizedConfigurationViewI<T> {
	/**
	 * When the edit of an action begins
	 * @param action the action that should be edited
	 */
	public void editStarts(T element);
}
