...
public class CreateConfigurationDesktopShortcutTask extends LCTask<Void> {
    ...
    protected CreateConfigurationDesktopShortcutTask(LCProfileI profile, LCConfigurationDescriptionI configuration) {
    ...
    protected Void call() throws Exception {
        ...
        if (SystemType.current() == SystemType.WINDOWS) {
            ...
            if (!desktopShortcutPath.exists()) {
                ShellLink lLink = ShellLink.createLink(UserConfigUtils.getLauncherPath().getAbsolutePath());
