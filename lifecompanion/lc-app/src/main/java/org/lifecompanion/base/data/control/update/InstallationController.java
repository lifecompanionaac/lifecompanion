...
public enum InstallationController implements LCStateListener {
    ...
    void tryToAddPluginsAfterDownload(java.util.List<Pair<ApplicationPluginUpdate, File>> updatedPlugins) {
        updatedPlugins.forEach(this::tryToAddPluginAfterDownload);
    }

    CheckAndDownloadPluginUpdateTask createCheckAndDowloadPluginTask(boolean pauseOnStart) {
