...
package org.lifecompanion.base.data.useaction.impl.text.upper;
...
public class EnableUpperCaseAction extends SimpleUseActionImpl<UseActionTriggerComponentI> {

	public EnableUpperCaseAction() {
		super(UseActionTriggerComponentI.class);
		this.category = DefaultUseActionSubCategories.UPPERCASE;
		this.nameID = "action.enable.upper.case.name";
		this.order = 0;
		this.staticDescriptionID = "action.enable.upper.case.description";
		this.configIconPath = "text/icon_switch_uppercase.png";
	...
	public void execute(final UseActionEvent eventP, final Map<String, UseVariableI<?>> variables) {
		WritingStateController.INSTANCE.switchUpperCase(WritingEventSource.USER_ACTIONS);
	}
	//========================================================================
}
