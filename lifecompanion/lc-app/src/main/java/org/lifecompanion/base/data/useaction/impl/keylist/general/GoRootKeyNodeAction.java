...
package org.lifecompanion.base.data.useaction.impl.keylist.general;
 ...
 */
public class GoRootKeyNodeAction extends SimpleUseActionImpl<UseActionTriggerComponentI> {

    public GoRootKeyNodeAction() {
        super(UseActionTriggerComponentI.class);
        this.order = 10;
        this.category = DefaultUseActionSubCategories.KEY_LIST_GENERAL;
        this.nameID = "go.root.list.current.list.name";
        this.staticDescriptionID = "go.root.list.current.list.description";
        this.configIconPath = "keylist/icon_go_root_keylist.png";
    ...
    public void execute(final UseActionEvent eventP, final Map<String, UseVariableI<?>> variables) {
        KeyListController.INSTANCE.goRootNode();
    }
}
