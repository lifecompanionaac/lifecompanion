    ...
    public void initListener() {
        ...
        this.addEventHandler(KeyEvent.KEY_PRESSED, eventP -> {
            if (LCConfigurationActions.KEY_COMBINATION_NEW.match(eventP)) {
                ...
                ComponentActionController.INSTANCE.copyComponent(SelectionController.INSTANCE.selectedDisplayableComponentHelperProperty().get(), SelectionController.INSTANCE.getSelectedKeys());
