...
public class ComponentSelectionPopTrigger extends BorderPane implements LCViewInitHelper {
    ...
    public void initUI() {
        ...
        boxRight.getStyleClass().addAll("border-lightgrey", "border-width-1-top-right-bottom", "border-radius-3-tp-br");
        ...
        this.selectionPaneView.getStyleClass().addAll("border-lightgrey", "border-width-1-top-bottom");
