...
public class ViewportSelectorControl extends BaseConfigurationViewBorderPane<ImageUseComponentI> implements LCViewInitHelper {
    ...
    private EventHandler<ActionEvent> okButtonHandler;

    public ViewportSelectorControl(EventHandler<ActionEvent> okButtonHandler) {
    ...
    public void initListener() {
        ...
        this.buttonOk.setOnAction(this.okButtonHandler);
    }
    //========================================================================
