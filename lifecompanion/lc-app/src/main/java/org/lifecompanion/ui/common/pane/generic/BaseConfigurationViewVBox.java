...
/**
 * Base implementation for {@link BaseConfigurationViewI} that use a {@link VBox} as view type.
 * @author Mathieu THEBAUD <math.thebaud@gmail.com>
 * @param <T> the type of component that this configuration view configures.
 */
public abstract class BaseConfigurationViewVBox<T> extends VBox implements BaseConfigurationViewI<T> {
	/**
	 * Model use in this configuration view
	 */
	protected ObjectProperty<T> model;

	public BaseConfigurationViewVBox() {
