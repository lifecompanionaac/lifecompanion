...
public class ConfigurationDescriptionAdvancedListCell extends ListCell<LCConfigurationDescriptionI> implements LCViewInitHelper {
    ...
    public void initUI() {
        ...
        this.buttonSelect = UIUtils.createGraphicButton(LCGlyphFont.FONT_AWESOME.create(FontAwesome.Glyph.CHEVRON_RIGHT).size(20).color(LCGraphicStyle.MAIN_DARK),
                "tooltip.config.list.select");
        this.buttonEdit = UIUtils.createGraphicButton(LCGlyphFont.FONT_AWESOME.create(FontAwesome.Glyph.GEAR).size(20).color(LCGraphicStyle.MAIN_DARK),
