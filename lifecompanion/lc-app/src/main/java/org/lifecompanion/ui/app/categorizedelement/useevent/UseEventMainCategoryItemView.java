...
public class UseEventMainCategoryItemView extends AbstractMainCategoryItemView<UseEventMainCategoryI> {

    public UseEventMainCategoryItemView(UseEventMainCategoryI item, final Consumer<UseEventMainCategoryI> categorySelectionCallbackP) {
