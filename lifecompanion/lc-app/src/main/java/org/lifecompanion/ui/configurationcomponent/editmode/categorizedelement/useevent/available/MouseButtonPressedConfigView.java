...
public class MouseButtonPressedConfigView extends HBox implements UseEventGeneratorConfigurationViewI<MouseButtonPressedEventGenerator> {
    ...
    @Override
    public Class<MouseButtonPressedEventGenerator> getConfiguredActionType() {
        return MouseButtonPressedEventGenerator.class;
    }
    ...
    @Override
    public void editEnds(final MouseButtonPressedEventGenerator element) {
        element.wantedButtonProperty().set(this.mouseButtonSelectorControl.valueProperty().get());
    }

    @Override
    public void editStarts(final MouseButtonPressedEventGenerator element) {
