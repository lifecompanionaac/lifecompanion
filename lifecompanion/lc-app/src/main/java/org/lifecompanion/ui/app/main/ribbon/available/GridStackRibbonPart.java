...
import org.lifecompanion.ui.app.main.ribbon.available.withselection.AbstractStackPartRibbonPart;
...
public class GridStackRibbonPart extends AbstractStackPartRibbonPart {
	...
	public void initModelBinding() {
		//Selection binding
		SelectionController.INSTANCE.selectedGridPartComponentProperty().addListener((obs, ov, nv) -> {
