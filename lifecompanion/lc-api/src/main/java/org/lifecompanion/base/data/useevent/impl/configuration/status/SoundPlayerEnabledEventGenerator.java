...
public class SoundPlayerEnabledEventGenerator extends BaseUseEventGeneratorImpl {

	public SoundPlayerEnabledEventGenerator() {
		super();
		this.parameterizableAction = false;
		this.order = 4;
		this.category = DefaultUseEventSubCategories.STATUS;
		this.nameID = "use.event.configuration.sound.player.enabled.name";
		this.staticDescriptionID = "use.event.configuration.sound.player.enabled.description";
		this.configIconPath = "configuration/icon_sound_disabled.png";
