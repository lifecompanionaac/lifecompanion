 ...
 */
public class PreviousInCurrentKeyListNoLoopAction extends SimpleUseActionImpl<UseActionTriggerComponentI> {


    public PreviousInCurrentKeyListNoLoopAction() {
        super(UseActionTriggerComponentI.class);
        this.order = 150;
        this.category = DefaultUseActionSubCategories.KEY_LIST_CURRENT;
        this.nameID = "action.previous.key.in.keylist.in.current.noloop.name";
        this.staticDescriptionID = "action.previous.key.in.keylist.in.current.noloop.description";
        this.configIconPath = "keylist/icon_previous_keylist_stop.png";
    ...
    public void execute(final UseActionEvent eventP, final Map<String, UseVariableI<?>> variables) {
        KeyListController.INSTANCE.previousInCurrentWithoutLoop();
    }
}
