...
/**
 * Action that should have the same effect as the back space key on a keyboard.<br>
 * This action repeat.
 *
 * @author Mathieu THEBAUD <math.thebaud@gmail.com>
 */
public class DeleteLastCharAndRepeatAction extends RepeatActionBaseImpl<UseActionTriggerComponentI> {

    public DeleteLastCharAndRepeatAction() {
        super(UseActionTriggerComponentI.class);
        this.category = DefaultUseActionSubCategories.DELETE_TEXT;
        this.nameID = "action.delete.last.char.and.repeat.name";
        this.staticDescriptionID = "action.delete.last.char.and.repeat.description";
