...
public class AssessmentSelectChoiceAutoEvsAction extends SimpleUseActionImpl<UseActionTriggerComponentI> implements SelectChoiceActionI {
    @XMLGenericProperty(Choice.class)
    private final ObjectProperty<Choice> choice;

    public AssessmentSelectChoiceAutoEvsAction() {
        super(UseActionTriggerComponentI.class);
        this.nameID = "ppp.plugin.actions.assessment.select_choice.auto_evs.name";
        this.staticDescriptionID = "ppp.plugin.actions.assessment.select_choice.auto_evs.description";
    ...
    public Element serialize(final IOContextI contextP) {
        ...
        XMLObjectSerializer.serializeInto(AssessmentSelectChoiceAutoEvsAction.class, this, node);
        return node;
    }
    ...
    public void deserialize(final Element nodeP, final IOContextI contextP) throws LCException {
        ...
        XMLObjectSerializer.deserializeInto(AssessmentSelectChoiceAutoEvsAction.class, this, nodeP);
    }
