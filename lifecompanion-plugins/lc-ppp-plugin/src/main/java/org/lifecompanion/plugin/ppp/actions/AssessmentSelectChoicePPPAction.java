...
public class AssessmentSelectChoicePPPAction extends SimpleUseActionImpl<UseActionTriggerComponentI> implements SelectChoiceActionI {
    @XMLGenericProperty(Choice.class)
    private final ObjectProperty<Choice> choice;

    public AssessmentSelectChoicePPPAction() {
        super(UseActionTriggerComponentI.class);
        this.nameID = "ppp.plugin.actions.assessment.select_choice.ppp.name";
        this.staticDescriptionID = "ppp.plugin.actions.assessment.select_choice.ppp.description";
