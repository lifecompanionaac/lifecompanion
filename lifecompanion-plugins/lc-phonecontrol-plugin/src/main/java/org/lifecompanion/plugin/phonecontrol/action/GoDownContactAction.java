...
public class GoDownContactAction extends SimpleUseActionImpl<UseActionTriggerComponentI> {
    public GoDownContactAction() {
        ...
        this.nameID = "phonecontrol.plugin.action.contactdownlist.name";
        this.staticDescriptionID = "phonecontrol.plugin.action.contactdownlist.description";
    ...
    public void execute(UseActionEvent event, Map<String, UseVariableI<?>> variables) {
        ConnexionController.INSTANCE.downConvIndex();
    }
}
