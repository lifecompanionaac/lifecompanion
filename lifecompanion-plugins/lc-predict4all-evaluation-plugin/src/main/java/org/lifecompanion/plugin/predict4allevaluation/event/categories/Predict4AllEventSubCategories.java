 ...
 */
public enum Predict4AllEventSubCategories implements UseEventSubCategoryI {
	...
	private Predict4AllEventSubCategories(final String nameId, final Color color) {
		this.nameId = nameId;
		this.id = this.name();
		this.color = color;
		Predict4AllEventMainCategory.INSTANCE.getSubCategories().add(this);
	}
	...
	@Override
	public Predict4AllEventMainCategory getMainCategory() {
		return Predict4AllEventMainCategory.INSTANCE;
	}
