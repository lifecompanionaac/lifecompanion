package org.lifecompanion.plugin.phonecontrol1.view;
...
import org.lifecompanion.plugin.phonecontrol1.PhoneControlPlugin;
import org.lifecompanion.plugin.phonecontrol1.PhoneControlPluginProperties;
...
public class PhoneControlGeneralConfigView extends BorderPane
    ...
    public String getTitleId() {
        return "phonecontrol1.plugin.config.title";
    }
    ...
    /**
     * Initialize the UI : Categories, labels, buttons, etc.
     */
    @Override
    public void initUI() {
        ...
        refreshDeviceListButton = new Button(Translation.getText("phonecontrol1.plugin.config.button.refresh.list"));
        ...
        speakerToggleButton = new ToggleSwitch(Translation.getText("phonecontrol1.plugin.config.label.speaker.on"));
        ...
        installAppButton = new Button(Translation.getText("phonecontrol1.plugin.config.button.install.app"));
    ...
    /**
     * Initialize the listeners : Add actions to buttons.
     */
    @Override
        ...
        this.installAppButton.setOnAction(event -> {
            ...
            Thread installThread = new Thread(() -> {
                ...
                if (deviceSerialNumber != null) {
                    ...
                    Platform.runLater(() -> {
                        labelInstallResult.setText(Translation.getText("phonecontrol1.plugin.config.label.no.device"));
                    });
                }
    ...
    private void refreshDeviceList() {
        ...
        Device noDeviceSelected = new Device(Translation.getText("phonecontrol1.plugin.config.label.no.device"), null);
