...
public class PhoneControlPlugin implements PluginI {
    ...
    public String[] getLanguageFiles(final String languageCode) {
        return new String[] { "/text/" + languageCode + "_phonecontrol1_plugin.xml" };
    }
    ...
    public List<UseVariableDefinitionI> getDefinedVariables() {
        return Arrays.asList(
                new UseVariableDefinition(
                        ...
                        "phonecontrol1.plugin.use.variable.sms.unread.name",
                        "phonecontrol1.plugin.use.variable.sms.unread.description",
                        "phonecontrol1.plugin.use.variable.sms.unread.example"),
                new UseVariableDefinition(
                        PhoneControlController.VAR_CALL_DURATION,
                        "phonecontrol1.plugin.use.variable.call.duration.name",
                        "phonecontrol1.plugin.use.variable.call.duration.description",
                        "phonecontrol1.plugin.use.variable.call.duration.example"),
                new UseVariableDefinition(
