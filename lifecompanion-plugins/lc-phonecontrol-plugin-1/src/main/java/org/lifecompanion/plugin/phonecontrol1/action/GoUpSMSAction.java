...
public class GoUpSMSAction extends SimpleUseActionImpl<UseActionTriggerComponentI> {
    ...
    public GoUpSMSAction() {
        ...
        this.nameID = "phonecontrol1.plugin.action.sms.up.list.name";
        this.staticDescriptionID = "phonecontrol1.plugin.action.sms.up.list.description";
    ...
    public void execute(UseActionEvent event, Map<String, UseVariableI<?>> variables) {
        PhoneControlController.INSTANCE.upSmsIndex();
    }
}
