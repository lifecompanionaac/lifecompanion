...
public class LastMessageAuthorMeUseEvent extends LastMessageAuthorChangeUseEvent {
    public LastMessageAuthorMeUseEvent() {
    ...
    public Element serialize(final IOContextI context) {
        ...
        XMLObjectSerializer.serializeInto(LastMessageAuthorMeUseEvent.class, this, element);
        return element;
    }
    ...
    public void deserialize(final Element node, final IOContextI context) throws LCException {
        ...
        XMLObjectSerializer.deserializeInto(LastMessageAuthorMeUseEvent.class, this, node);
    }
}
