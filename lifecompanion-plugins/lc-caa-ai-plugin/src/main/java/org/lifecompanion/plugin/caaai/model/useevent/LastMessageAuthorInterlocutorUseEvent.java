...
import org.lifecompanion.plugin.caaai.model.useevent.common.LastMessageAuthorChangeUseEvent;

public class LastMessageAuthorInterlocutorUseEvent extends LastMessageAuthorChangeUseEvent {
    public LastMessageAuthorInterlocutorUseEvent() {
    ...
    public Element serialize(final IOContextI context) {
        ...
        XMLObjectSerializer.serializeInto(LastMessageAuthorInterlocutorUseEvent.class, this, element);
        return element;
    }
    ...
    public void deserialize(final Element node, final IOContextI context) throws LCException {
        ...
        XMLObjectSerializer.deserializeInto(LastMessageAuthorInterlocutorUseEvent.class, this, node);
    }
}
