...
public class CallTheNameInTheInputBox extends SimpleUseActionImpl<UseActionTriggerComponentI> {
    ...
    public CallTheNameInTheInputBox() {
        ...
        this.nameID = "phonecontrol2.plugin.action.call.the.name.in.the.input.box.name";
        this.staticDescriptionID = "phonecontrol2.plugin.action.call.the.name.in.the.input.box.description";
