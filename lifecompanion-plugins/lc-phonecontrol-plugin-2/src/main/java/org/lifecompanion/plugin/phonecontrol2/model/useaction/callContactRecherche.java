...
public class callContactRecherche extends SimpleUseActionImpl<UseActionTriggerComponentI> {
    ...
    public callContactRecherche() {
        ...
        this.nameID = "phonecontrol2.plugin.action.callContactRecherche.name";
        this.staticDescriptionID = "phonecontrol2.plugin.action.callContactRecherche.description";
