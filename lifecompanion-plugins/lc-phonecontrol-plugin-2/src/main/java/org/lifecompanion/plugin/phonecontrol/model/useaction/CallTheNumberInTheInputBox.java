...
public class CallTheNumberInTheInputBox extends SimpleUseActionImpl<UseActionTriggerComponentI> {
    ...
    public CallTheNumberInTheInputBox() {
        ...
        this.nameID = "phonecontrol.plugin.action.call.the.number.in.the.input.box.name";
        this.staticDescriptionID = "phonecontrol.plugin.action.call.the.number.in.the.input.box.description";
