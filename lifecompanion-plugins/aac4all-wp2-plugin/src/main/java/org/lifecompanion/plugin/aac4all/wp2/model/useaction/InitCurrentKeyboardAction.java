...
public class InitCurrentKeyboardAction extends SimpleUseActionImpl<GridPartKeyComponentI> {

    public InitCurrentKeyboardAction() {
        super(GridPartKeyComponentI.class);
        this.category = AAC4AllWp2SubCategories.TODO;
        this.nameID = "aac4aal.wp2.plugin.action.init.current.keyboard.name";
        this.staticDescriptionID = "aac4aal.wp2.plugin.action.init.current.keyboard.description";
    ...
    public void execute(final UseActionEvent event, final Map<String, UseVariableI<?>> variables) {
        AAC4AllWp2EvaluationController.INSTANCE.initCurrentKeyboard();
    }
