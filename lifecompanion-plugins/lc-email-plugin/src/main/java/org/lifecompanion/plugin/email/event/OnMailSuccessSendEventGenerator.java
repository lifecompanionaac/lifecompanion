 ...
 */
public class OnMailSuccessSendEventGenerator extends BaseUseEventGeneratorImpl {

    private final Consumer<Boolean> mailSentCallback;

    public OnMailSuccessSendEventGenerator() {
        super();
        this.parameterizableAction = false;
        this.order = 20;
        this.category = EmailEventSubCategories.SEND;
        this.nameID = "email.plugin.use.event.mail.success.sent.name";
        this.staticDescriptionID = "email.plugin.use.event.mail.success.sent.description";
    ...
    public String getConfigIconPath() {
        return "use-events/icon_event_message_success.png";
    }
