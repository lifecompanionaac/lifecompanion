 ...
 */
public enum EmailEventMainCategory implements UseEventMainCategoryI {
    INSTANCE;
    private static final String ID = "EMAIL_EVENT_MAIN_CATEGORY";

    private ObservableList<UseEventSubCategoryI> subCategories = FXCollections.observableArrayList();

    @Override
    public String getStaticDescription() {
        return Translation.getText("email.plugin.use.event.mail.main.category.description");
    }

    @Override
    public String getName() {
        return Translation.getText("email.plugin.use.event.mail.main.category.name");
    }

    @Override
    public String getConfigIconPath() {
        return "use-events/icon_main_category_emails.png";
    }
    ...
    @Override
    public String getID() {
        return EmailEventMainCategory.ID;
    }
