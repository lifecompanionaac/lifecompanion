...
public enum TranslateActionSubCategories implements UseActionSubCategoryI {
    ...
    TranslateActionSubCategories(final String nameId, final Color color) {
        this.nameId = nameId;
        this.id = this.name();
        this.color = color;
        TranslateActionMainCategory.INSTANCE.getSubCategories().add(this);
    }
    ...
    public UseActionMainCategoryI getMainCategory() {
        return TranslateActionMainCategory.INSTANCE;
    }
