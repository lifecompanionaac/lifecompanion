...
public class WindowsRegUtils {
     ...
     */
    public static void createFileAssociation(final String extension, final File executableFile, File icoFile, final String softwareName, final String description)
